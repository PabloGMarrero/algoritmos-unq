class Procedure():
    def __init__(self, random_greedy, adaptive_search, max_search_procedure,limit_adaptive_search, matrix ) -> None:
    ...
    def do_grasp(self):
        ...
        as_best_solution, as_best_cost = self.adaptive_search.search(better_solution, better_cost, self.matrix, [], self.limit_adaptive_search)
