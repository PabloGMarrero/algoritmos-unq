...
#adaptive_solution = adaptive_search.search(circuit_random_greedy, better_distance, matrix, result_iterations=[], limit=10.0)
#print("Adaptive solution: ", adaptive_solution)

limit_adaptive_search=10.0
max_search_procedure=5
solution=None
procedure_1 = Procedure(random_greedy, adaptive_search, max_search_procedure, limit_adaptive_search, matrix)
